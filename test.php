                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><a href="#" target="_blank"><i class="fa fa-link"> </i> <?php echo lng('Check Latest Version') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="$" target="_blank" class="float-right text-muted">CODEX CYBER ARMY <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="" target="_blank" class="float-right text-muted">CODEX CYBER ARMY <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
